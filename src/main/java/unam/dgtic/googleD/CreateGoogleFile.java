...
public class CreateGoogleFile {
    ...
    public static void main(String[] args) throws IOException {
        ...
        java.io.File uploadFile = new java.io.File("/Users/edher/Downloads/datos.txt");
 
        // Create Google File:
 
        File googleFile = createGoogleFile("1A46XUtFwHPkYKglySYE6F7uZBowtvvIQ", "text/plain", "newfileTEST1.txt", uploadFile);
